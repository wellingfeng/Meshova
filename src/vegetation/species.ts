...
export const VEGETATION_SPECIES_PRESETS: Record<VegetationSpecies, VegetationSpeciesPreset> = {
  oak: {
    ...
    tree: {
      ...
      canopy: { shape: "ellipsoid", baseY: 1.05, height: 3.65, radiusX: 2.05, radiusZ: 1.8, strength: 0.55, minScale: 0.42 },
  ...
  maple: {
    ...
    tree: {
      ...
      canopy: { shape: "ellipsoid", baseY: 1.0, height: 3.2, radiusX: 1.65, radiusZ: 1.55, strength: 0.52, minScale: 0.4 },
  ...
  birch: {
    ...
    tree: {
      ...
      canopy: { shape: "column", baseY: 1.25, height: 3.9, radiusX: 1.05, radiusZ: 0.95, strength: 0.6, minScale: 0.5 },
  ...
  willow: {
    ...
    tree: {
      ...
      canopy: { shape: "umbrella", baseY: 1.15, height: 3.7, radiusX: 1.85, radiusZ: 1.7, strength: 0.55, minScale: 0.45 },
