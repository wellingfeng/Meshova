/**
 * Rooftop water tower — CitySample Kit_roof_tank. Emits OBJ + viewer JSON and
 * registers into out/models.json.
 *
 * Run: pnpm tsx examples/water-tower.ts
 */
import { toOBJScene, toViewerModel } from "../src/index.js";
import { buildWaterTowerParts, type NamedPart } from "../src/index.js";
...
emit("water-tower", "屋顶木水塔", buildWaterTowerParts({}));
