/**
 * Titan Tree — from "Tree_PivotPainter_Tutorial" (project_titan). Recursive branch
 * skeleton with per-branch pivot/parent/level records (the PivotPainter data).
 *
 * Run: pnpm tsx examples/titan-tree.ts
 */
import { toOBJScene, toViewerModel } from "../src/index.js";
import { buildTitanTreeParts, type NamedPart } from "../src/index.js";
...
emit("titan-tree", "泰坦树", buildTitanTreeParts({ levels: 4 }));
