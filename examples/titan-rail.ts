/**
 * Titan Rail — reverse-engineered from Houdini "Tutorial_Rail.hda" (project_titan).
...
import { buildTitanRailParts, type NamedPart } from "../src/index.js";
...
emit("titan-rail", "泰坦轨道", buildTitanRailParts({ bend: 8, length: 48 }));
