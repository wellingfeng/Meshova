/**
 * Procedural SILO-inspired shaft scene. Emits OBJ + viewer JSON and registers
 * into out/models.json.
 *
 * Run: pnpm tsx examples/procedural-silo.ts
 */
...
emit("procedural-silo", "程序化筒仓", buildProceduralSiloParts({}));
