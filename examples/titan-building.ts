/**
 * Titan Building — reverse-engineered from Houdini "Tutorial_Building_Generator.hda" (project_titan).
...
import { buildTitanBuildingParts, type NamedPart } from "../src/index.js";
...
emit("titan-building", "泰坦建筑", buildTitanBuildingParts({}));
