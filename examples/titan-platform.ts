/**
 * Titan Platform — reverse-engineered from Houdini "Tutorial_platform.hda" (project_titan).
...
import { buildTitanPlatformParts, type NamedPart } from "../src/index.js";
...
emit("titan-platform", "泰坦平台", buildTitanPlatformParts({}));
