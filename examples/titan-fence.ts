/**
 * Titan Fence — reverse-engineered from Houdini "Tutorial_fence.hda" (project_titan).
...
import { buildTitanFenceParts, type NamedPart } from "../src/index.js";
...
emit("titan-fence", "泰坦栅栏", buildTitanFenceParts({ bend: 5, length: 40 }));
