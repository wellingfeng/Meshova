/**
 * Titan Cable — reverse-engineered from Houdini "tutorial_cable.hda" (project_titan).
...
import { buildTitanCableParts, type NamedPart } from "../src/index.js";
...
emit("titan-cable", "泰坦电缆", buildTitanCableParts({ poles: 5, span: 12 }));
