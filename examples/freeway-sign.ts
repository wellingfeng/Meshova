/**
 * Freeway overhead sign gantry — CitySample Kit_FreewaySign. Emits OBJ + viewer
 * JSON and registers into out/models.json.
 *
 * Run: pnpm tsx examples/freeway-sign.ts
 */
import { toOBJScene, toViewerModel } from "../src/index.js";
import { buildFreewaySignParts, type NamedPart } from "../src/index.js";
...
emit("freeway-sign", "高速龙门牌", buildFreewaySignParts({ signCount: 2 }));
